! ( function () {
	...
	function t( t ) {
		...
		return ( 0, e.createElement )(
			'div',
			{ className: `countdown__${ s.toLowerCase() }` },
			( 0, e.createElement )( 'span', null, i ),
			( 0, e.createElement )( 'span', { className: 'label' }, s )
		);
	}
	function s() {
	...
	var k = {
		...
		updateSlides: function () {
			...
			for ( let a = 0; a < u; a += 1 ) {
				...
				if (
					...
					if ( 'auto' === i.slidesPerView ) {
						...
						( k =
							( n - ( i.slidesPerView - 1 ) * E ) /
							i.slidesPerView ),
							i.roundLengths && ( k = Math.floor( k ) ),
							p[ a ] &&
								( p[ a ].style[ t( 'width' ) ] = `${ k }px` );
			...
			if (
				...
				m( a, '--swiper-centered-offset-before', -f[ 0 ] + 'px' ),
					m(
						a,
	...
	function A( e ) {
		...
		if ( d.preventedByNestedSwiper )
			return ( r.startX = m ), void ( r.startY = f );
		if ( ! s.allowTouchMove )
			return (
		...
		if (
			s.params.threshold &&
			Math.sqrt( h ** 2 + g ** 2 ) < s.params.threshold
		)
			return;
		if ( void 0 === i.isScrolling ) {
			...
			( s.isVertical() && r.currentX === r.startX )
				...
				: h * h + g * g >= 25 &&
				  ( ( e =
						( 180 * Math.atan2( Math.abs( g ), Math.abs( h ) ) ) /
						Math.PI ),
	...
	function G( e ) {
		...
		for (
			...
			void 0 !== l[ e + t ]
				? f >= l[ e ] &&
				  ...
				  ( ( h = e ), ( g = l[ e + t ] - l[ e ] ) )
				: f >= l[ e ] &&
				  ( ( h = e ), ( g = l[ l.length - 1 ] - l[ l.length - 2 ] ) );
		}
		let v = null,
			w = null;
		a.rewind &&
		...
		if ( m > a.longSwipesMs ) {
			...
			'next' === t.swipeDirection &&
				( b >= a.longSwipesRatio
					? t.slideTo( a.rewind && t.isEnd ? v : h + S )
					: t.slideTo( h ) ),
			...
			( p.target !== t.navigation.nextEl &&
				...
				? ( 'next' === t.swipeDirection &&
						t.slideTo( null !== v ? v : h + S ),
				  'prev' === t.swipeDirection &&
						t.slideTo( null !== w ? w : h ) )
				: p.target === t.navigation.nextEl
				? t.slideTo( h + S )
				: t.slideTo( h );
		}
	...
	function Q( e ) {
		let t =
			arguments.length > 1 && void 0 !== arguments[ 1 ]
				? arguments[ 1 ]
				: {};
		window.innerWidth < 767 && ( J.slidesPerView = 1 );
		const s = Object.assign( {}, J, t );
		return new Y( e, s );
	}
	...
	console.log( 'hi there from frontpage.js' ),
		document.querySelectorAll( '.fadeIn' ).forEach( ( e ) => {
			Z.observe( e ),
				...
				e.classList.add( 'fadeIn--hide' );
		} ),
		( function () {
			const e = document.getElementById( 'entertainment-slider' ),
				t = document.getElementById( 'registration-slider' );
			Q( e ), Q( t );
		} )(),
		( 0, e.createRoot )( document.getElementById( 'countdown' ) ).render(
			( 0, e.createElement )( function () {
				return ( 0, e.createElement )( s, null );
			}, null )
		);
} )();
