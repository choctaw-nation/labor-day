! ( function () {
	...
	function t( t ) {
		let { removeEvent: a, id: n, day: l } = t;
	...
	function a( e ) {
		return new Date( `2023-09-01T${ e }` ).toLocaleTimeString( [], {
			hour: 'numeric',
			minute: '2-digit',
			hour12: ! 0,
		} );
	...
	function n( n ) {
		let { schedule: l, day: s, removeEvent: c } = n;
		return ( 0, e.createElement )(
			e.Fragment,
			null,
			l.map( ( n ) => {
				...
				return ( 0, e.createElement )(
					'div',
					{ className: 'my-schedule__event', key: i },
					( 0, e.createElement )( t, {
						removeEvent: c,
						id: i,
						day: s,
					...
					( 0, e.createElement )(
						...
						( 0, e.createElement )(
							...
							{
								className:
									'my-schedule__event-details--description text-content',
							},
							u
						),
						( 0, e.createElement )(
							'a',
							{ href: m, className: 'btn__outline--primary' },
							'View Event'
						)
					)
				);
	...
	s &&
		( 0, e.createRoot )( s ).render(
			( 0, e.createElement )( function () {
				const [ t, a ] = ( 0, e.useState )( ! 0 ),
					[ s, c ] = ( 0, e.useState )( {
						friday: [],
						saturday: [],
						sunday: [],
				...
				( 0, e.useEffect )( () => {
					const e = ( function () {
						...
						return (
							[ 'friday', 'saturday', 'sunday' ].forEach(
								( e ) => {
									t[ e ]
										.filter(
											( t ) => (
