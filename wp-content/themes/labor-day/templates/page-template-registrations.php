...
<main class="site-content">
	<?php if ($background_image_url) : ?>
		<section class='w-100' id='hero' style="background-image:url('<?php echo $background_image_url; ?>')"></section>
	...
	<?php else : ?>
		<section class='w-100' id='vendor-application-hero' style='background-color:var(--color-tertiary);'>
			<div class="container">
				<?php the_title("<h1 class='headline'>", "</h1>"); ?>
